...
/** The number of pixels to reserve at the top and bottom */
	...
	// The number of pixels of the bottom bar with textfield and buttons
	public static final int BOTTOM_BAR_HEIGHT = 100;
	
	// the width of each decade bar
	public static final int DECADE_WIDTH = APPLICATION_WIDTH/11;

	// the height of the graph space
	public static final int GRAPH_HEIGHT = APPLICATION_WIDTH - GRAPH_MARGIN_SIZE - BOTTOM_BAR_HEIGHT;
